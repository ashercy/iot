...
public:
   ...
   * @retval false Failed
   */
  bool mqttPublish(const char* iot_topic, const char* iot_data);
  bool mqttCONNandPUB(const char* iot_client, const char* iot_username, const char* iot_key, const char* iot_topic, const char* iot_data);
  /**
   * @fn mqttSubscribe
